      ...
      <div className="body">
        <div className="left">
          ...
          <div className="who">
            ...
            <p>
              An organization where professional musicians are raised for
              personal fulfillment and for positive global impacts
            </p>
            <h4>MISSION</h4>
            <p>
              To create an integrated platforms that discover, develop and
              deploy music and artistic potentials.
            </p>
            <h4>OBJECTIVE</h4>
            <p>
              Our objective is to identify, raise and build potential leaders we
              come in contact with through our networking arms by our
              organization values
            </p>
            ...
            <div className="cores">
              ...
              <div className="cont">
                ...
                <p>
                  ...
                  our words and behavior. i.e we say what we do and we do what
                  we say
                </p>
              </div>
              <div className="cont">
